...
function Footer({lang, currProfile}: {lang: Dictionary, currProfile?: ProfileDetail | null}) {
    return <div className="mt-20 sm:flex-row flex-col flex p-4 border-gray-500 sm:justify-between justify-center"
        ...
        <div className="flex flex-col justify-center sm:justify-start">
            <div className={'flex-row-item-center justify-center sm:justify-start'}>
                ...
                <a href={'https://www.sociallayer.im/'} className="ml-3">{lang['About us']}</a>
        ...
        <div className="flex flex-col sm:mt-0 mt-3 items-center sm:items-start">
            ...
            <div className="flex-row-item-center justify-start">
                ...
                <a href={'https://t.me/sociallayer_im'} target='_blank' className="mr-2">
                    <svg className="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <a href={'https://github.com/sociallayer-im/seastar-app/issues'} target='_blank' className="mr-2">
                    <i className="media-github text-xl"/>
                </a>
            </div>
        </div>
    </div>
