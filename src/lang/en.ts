export const en = {
    ...
    "Input meeting url": "Input meeting url, or paste a Tencent Meeting invite",
    ...
    "Close Event": "Close Event Registration",
    ...
    "Require approval for events": "Require approval for events",
    "Events created by non-managers stay pending until a manager approves them": "Events created by non-managers stay pending until a manager approves them",
    ...
    "Monthly membership card": "Monthly membership card",
    "Monthly membership card hint": "Buying this ticket grants Member status for 30 days. Buying again before it expires extends the remaining time by 30 more days.",
    ...
    "Join this event on Social Layer": "Join this event on Social Layer",
    "Tap ··· in the top right to share to WeChat": "Tap ··· in the top right to share to WeChat",
    ...
    'WeChat Pay charges a {wechat_pct}% fee and sola charges a {sola_pct}% fee; the rest is available to withdraw.':
        'WeChat Pay charges a {wechat_pct}% fee and sola charges a {sola_pct}% fee; the rest is available to withdraw.',
    'WeChat Pay Withdrawals': 'WeChat Pay Withdrawals',
    'View your withdrawal records and request a withdrawal': 'View your withdrawal records and request a withdrawal',
    'WeChat Pay withdrawal intro':
        'WeChat Pay orders are collected into sola\'s own merchant account, so payouts to organizers are settled by hand rather than transferred automatically. Withdrawing takes out your entire available balance; a team member will process it and update the status here.',
    'Withdraw All': 'Withdraw All',
    'Confirm Withdrawal': 'Confirm Withdrawal',
    'Withdrawal requested': 'Withdrawal requested — it will be settled by hand and marked complete here.',
    'Bank Name': 'Bank Name',
    'Bank Account Number': 'Bank Account Number',
    'Bank Account Holder Name': 'Bank Account Holder Name',
    'Cumulative withdrawn': 'Cumulative withdrawn',
    'Withdrawal Records': 'Withdrawal Records',
    'No withdrawal records yet': 'No withdrawal records yet',
    'Prev': 'Prev',
    'Note for the group\'s managers (optional)': 'Note for the group\'s managers (optional)',
    'Reason for rejecting (shown to the group\'s managers)': 'Reason for rejecting (shown to the group\'s managers)',
    'Admin: WeChat Pay Withdrawals': 'Admin: WeChat Pay Withdrawals',
    'Requested by': 'Requested by',
    'Processed by': 'Processed by',
    'Mark Settled': 'Mark Settled',
    'Mark this withdrawal as settled? Only do this after the bank transfer has actually been sent.':
        'Mark this withdrawal as settled? Only do this after the bank transfer has actually been sent.',
    'Reject this withdrawal? The amount becomes available to request again.':
        'Reject this withdrawal? The amount becomes available to request again.',
    'No groups to manage withdrawals for': 'No groups to manage withdrawals for',
    'This balance is shared with the group\'s other managers.': 'This balance is shared with the group\'s other managers.',
