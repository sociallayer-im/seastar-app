export const en = {
    ...
    'Custom domain intro': 'Bind a domain you own so this group\'s fediverse handle reads @name@your-domain. Your existing handle keeps working, and followers are unaffected either way — the domain carries the handle, not the identity.',
    'Current handle': 'Current handle',
    'Canonical handle keeps working': 'This handle keeps working',
    'Bound': 'Bound',
    'Unbind domain': 'Unbind domain',
    'Domain unbound': 'Domain unbound',
    'Unbind is lossless': 'Unbinding does not affect followers or existing links.',
    'Step 1: claim the domain': 'Step 1: claim the domain',
    'Get DNS record': 'Get DNS record',
    'Challenge created': 'DNS record ready — add it at your registrar',
    'Step 2: add these DNS records': 'Step 2: add these DNS records',
    'Proves you own the domain': 'Proves you own the domain',
    'Points the domain here': 'Points the domain at this server (ask the operator to add the route)',
    'Step 3: verify': 'Step 3: verify',
    'Verify and bind': 'Verify and bind',
    ...
    'Give this id to the destination': 'The destination server needs this id to accept the move.',
    'This group has moved': 'This group has announced a move',
    'Moving a group here': 'Moving a group here',
    'Alias intro': 'Declare an identity you own elsewhere as a former self. The other server\'s move is only accepted once this claim exists — that is what stops anyone from redirecting someone else\'s followers.',
    'Alias removed': 'Removed',
    'Add former identity': 'Add former identity',
    'Alias added': 'Added',
    'Moving this group away': 'Moving this group away',
    'Move intro': 'Announce that this group now lives on another server. Followers there will be asked to follow the new address. The destination must list this group as a former identity first, or the announcement is refused.',
    'Move confirm': 'Followers will be re-pointed to the new address and new posts should be published there from now on. This cannot be recalled.',
    'Yes, announce the move': 'Yes, announce the move',
    'Announce move': 'Announce move',
    'Move announced': 'Move announced',
    'Former Identities': 'Former Identities',
    'This account\'s ActivityPub id': 'This account\'s ActivityPub id',
}
