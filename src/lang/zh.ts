...
export const zh: Dictionary = {
    ...
    'Available': '可用',
    'Unavailable': '不可用',
    'Due to the timeslot settings of the venue, only same-day events can be created': '由于场地的可用时间段设置，只能创建日内的活动',
    ...
    'The date you selected is not available for the current venue due to the timeslot settings': '由于可用时间段设置，您选择的日期对于当前场地不可用',
    ...
    'Only program members or group managers can view events in the program.': '只有项目成员或群组管理员可以查看项目中的活动',
    'Remove Program': '移除项目',
