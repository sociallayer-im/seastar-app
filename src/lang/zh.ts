...
export const zh: Dictionary = {
  ...
  "Importing external event details will disregard ticket information and online meeting addresses. Please manually edit these details.":
    "导入外部活动详情将忽略<b>门票信息</b>和<b>在线会议地址</b>。请手动编辑这些详情。",
  ...
  'Fediverse': '联邦宇宙',
  'Events from other servers in the fediverse': '来自其他服务器上社区发布的活动。',
  'Find a community on another server': '查找其他服务器上的社区',
  'No remote events yet — follow a community to see its events here': '还没有远端活动，关注一个社区后它的活动会出现在这里。',
  'Upcoming events': '即将开始',
  'Follow requested': '已发送关注请求，由对方服务器决定。',
  'Join requested': '已发送报名请求，由主办服务器确认。',
  'Requested': '待确认',
  'Going': '已参加',
  'Declined': '已被拒绝',
  'Invite only': '仅限邀请',
  'Register on the origin site': '前往源站报名',
  'from': '来自',
  'Follow': '关注',
  'Join': '报名',
  'Leave': '取消报名',
  ...
  'Unfollow': '取消关注',
    'Custom Domain': '自定义域名',
    'Custom domain intro': '绑定你拥有的域名，让这个社群的联邦账号显示为 @名称@你的域名。原有账号地址继续有效，关注者也不受影响——域名承载的是账号名，不是身份。',
    'Current handle': '当前账号地址',
    'Canonical handle keeps working': '此地址继续有效',
    'Bound': '已绑定',
    'Unbind domain': '解除绑定',
    'Domain unbound': '已解除绑定',
    'Unbind is lossless': '解绑不会影响关注者或已有链接。',
    'Step 1: claim the domain': '第一步：填写域名',
    'Get DNS record': '获取 DNS 记录',
    'Challenge created': 'DNS 记录已生成，请到域名服务商处添加',
    'Step 2: add these DNS records': '第二步：添加这些 DNS 记录',
    'Proves you own the domain': '用于证明域名归你所有',
    'Points the domain here': '把域名指向本服务器（需请管理员添加路由）',
    ...
    'Give this id to the destination': '目标服务器需要这个标识才能接收迁移。',
    'This group has moved': '本社群已宣告迁移',
    'Moving a group here': '把社群迁移到这里',
    'Alias intro': '声明你在其他服务器上拥有的身份为前身。只有先有这项声明，对方的迁移才会被接受——这正是防止他人劫持关注者的机制。',
    'Alias removed': '已移除',
    'Add former identity': '添加前身身份',
    'Alias added': '已添加',
    'Moving this group away': '把社群迁出',
    'Move intro': '宣告这个社群已迁往另一台服务器，对方的关注者会被引导去关注新地址。目标服务器必须先把本社群列为前身，否则宣告会被拒绝。',
    'Move confirm': '关注者将被重新指向新地址，此后应在新服务器发布内容。此操作无法撤回。',
    'Yes, announce the move': '确认宣告迁移',
    'Announce move': '宣告迁移',
    'Move announced': '已宣告迁移',
    'Former Identities': '前身身份',
    'This account\'s ActivityPub id': '本账号的 ActivityPub 标识',
}
