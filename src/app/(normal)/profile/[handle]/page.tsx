                    ...
                    <div className="px-3 mt-[-40px]">
                        ...
                        <div className="flex-row-item-center my-2">
                            ...
                            {isSelf &&
                                <>
                                    {!!currProfile!.eth &&
                                        <BtnShowAddress address={currProfile!.eth} label={{
                        ...
                        {!!currProfile && <SelectedBadgeWannaSend
                            lang={lang}
                            toProfileHandle={profile.name !== currProfile.name ? profile.name : undefined}
