...
import GroupDomainForm from './GroupDomainForm'

interface Props {
    params: {grouphandle: string}
}

export default async function GroupDomainPage({params}: Props) {
    ...
    return <div className="min-h-[calc(100svh-48px)] w-full">
        <div className="page-width-md min-h-[calc(100svh-48px)] px-3 !pb-12 pt-0">
            <div className="py-6 font-semibold text-center text-xl">{lang['Custom Domain']}</div>
